...
public class InfomapFactory<CONFIG extends InfomapBaseConfig> implements AlgorithmFactory<Infomap, CONFIG> {
    ...
    public MemoryEstimation memoryEstimation(CONFIG config) {
        return MemoryEstimations.builder(Infomap.class)
            .add("mapEquationOptimization()", MapEquationOptimizationFactory.MEMORY_ESTIMATION)
            .rangePerGraphDimension("subGraph", (graphDimensions, concurrency) -> {
                ...
                // Infomap creates a new graph every iteration, this graph has one relationship property
